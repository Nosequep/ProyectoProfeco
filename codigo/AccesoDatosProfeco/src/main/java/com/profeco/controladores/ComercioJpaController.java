...
public class ComercioJpaController implements Serializable {
    ...
    public void create(Comercio comercio) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findComercio(comercio.getIdcomercio()) != null) {
                throw new PreexistingEntityException("Comercio " + comercio + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
